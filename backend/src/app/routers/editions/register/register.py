...
from src.app.utils.dependencies import get_edition, check_latest_edition
...
@registration_router.post("/email", status_code=status.HTTP_201_CREATED, dependencies=[Depends(check_latest_edition)])
