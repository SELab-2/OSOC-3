...
@pytest.fixture
def database_with_data(database_session: AsyncSession) -> AsyncSession:
...
def test_new_suggestion(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_overwrite_suggestion(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_new_suggestion_not_authorized(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_get_suggestions_of_student_not_authorized(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_get_suggestions_of_ghost(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_get_suggestions_of_student(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_delete_ghost_suggestion(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_delete_not_autorized(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_delete_suggestion_admin(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_delete_suggestion_coach_their_review(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_delete_suggestion_coach_other_review(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_update_ghost_suggestion(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_update_not_autorized(database_with_data: AsyncSession, auth_client: AuthClient):
    """Tests update when not autorized"""
    assert auth_client.put("/editions/ed2022/students/1/suggestions/8000", json={
                           "suggestion": 1, "argumentation": "test"}).status_code == status.HTTP_401_UNAUTHORIZED


def test_update_suggestion_admin(database_with_data: AsyncSession, auth_client: AuthClient):
    """Test that an admin can update suggestions"""
    auth_client.admin()
...
def test_update_suggestion_coach_their_review(database_with_data: AsyncSession, auth_client: AuthClient):
...
def test_update_suggestion_coach_other_review(database_with_data: AsyncSession, auth_client: AuthClient):
